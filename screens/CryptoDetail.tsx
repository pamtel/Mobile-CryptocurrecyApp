...
export const CryptoDetail = ({ route, navigation }: Iprops): JSX.Element => {
  ...
  const scrollX = new Animated.Value(0) as any;
  ...
  const optionOnClickHandler = (option: IchartOptions) => {
        ...
        >
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            <View style={{ marginRight: SIZES.base }}>
              <Text style={{ fontWeight: '600', ...FONTS.h3 }}>
  ...
  const renderAbout = () => {
    return (
      ...
      >
        <Text style={{ fontWeight: '700', ...FONTS.h3 }}>
          About {selectedCurrency?.currency}
        </Text>
        <Text style={{ marginTop: SIZES.base, fontWeight: '500', ...FONTS.body3 }}>
